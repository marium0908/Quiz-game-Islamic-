...
function checkAnswer(selected) {
  ...
  const options = document.querySelectorAll('.option'); // Assuming options have the class 'option'
  ...
  // Show the correct or incorrect button based on the answer
  if (selected === correct) {
    score++;
    correctBtn.style.display = "inline-block"; // Show the correct button
  } else {
    incorrectBtn.style.display = "inline-block"; // Show the incorrect button
  }
